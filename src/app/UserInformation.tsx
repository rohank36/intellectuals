    ...
    if(isLoading){
        ...
        return (
            <div className="flex flex-col justify-center items-center h-screen">
                ...
                <label className="input input-bordered flex items-center gap-4 mb-4 tooltip tooltip-right" data-tip="This is will be seen by other players, be creative but make sure people know its you!">
